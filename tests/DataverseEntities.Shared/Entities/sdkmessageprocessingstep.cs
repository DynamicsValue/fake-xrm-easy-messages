...
namespace DataverseEntities
{
	...
	public partial class SdkMessageProcessingStep : Microsoft.Xrm.Sdk.Entity
	{
		...
		public System.Collections.Generic.IEnumerable<DataverseEntities.AsyncOperation> SdkMessageProcessingStep_AsyncOperations
		{
			get
			{
				return this.GetRelatedEntities<DataverseEntities.AsyncOperation>("SdkMessageProcessingStep_AsyncOperations", null);
			}
			set
			{
				this.SetRelatedEntities<DataverseEntities.AsyncOperation>("SdkMessageProcessingStep_AsyncOperations", null, value);
			}
		}
