...
namespace FakeXrmEasy.FakeMessageExecutors
{
    ...
    /// </summary>
    public class SendFaxRequestExecutor: IFakeMessageExecutor
    {
        /// <summary>
        ...
        {
            return request is SendFaxRequest;
        }
        ...
        {
            throw FakeOrganizationServiceFaultFactory.New(ErrorCodes.NotSupported,
                "Sending faxes is not supported");
        }
    }
}